export const personalInfo = {
  ...
  stats: [
    ...
    { value: "170K+", label: "Assets managed" },
...
export const projects = [
  ...
  {
    id: 3,
    title: "Rail Asset Management",
    description:
      "Enterprise system managing 170K+ rail assets with sub-second real-time updates. Angular OnPush strategy delivered 20% TBT reduction at 60 FPS under high data load. CI/CD standardisation improved deployment speed by 15%.",
...
export const skills = {
  ...
  "Backend": ["Node.js", "Express", "REST APIs", "CI/CD", "Docker", "Git", "C++", "Java", "SQL"],
  "AI / ML": ["OpenAI APIs", "Whisper (ASR)", "HuggingFace Transformers", "RAG", "Vector Embeddings"],
  "Cloud & Data": ["AWS (S3, Lambda, CloudFront, EventBridge)", "SAP BTP", "SAP HANA", "MongoDB", "Redis", "PostgreSQL"],
};
...
export const certifications = [
  {
    ...
    issuer: "HackerRank",
    date: "2023",
    credentialUrl: "https://www.hackerrank.com/bkumar28899",
    color: "#2EC866",
  ...
  },
  {
    ...
    credentialUrl: "#",
    color: "#0FAAFF",
    skills: ["SAP BTP", "CAP Framework", "Node.js"],
  },
  {
    id: 4,
